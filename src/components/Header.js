...
export const Header = () => {
  ...
  const inactiveClass =
    "text-base block py-2 px-3 text-gray-900 rounded-sm hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700";
  ...
  return (
    <header>
      <nav
        className="bg-white border-b-2 border-gray-200 sm:px-4 py-2
      dark:bg-gray-900 dark:border-b-1 dark:border-gray-900"
      >
